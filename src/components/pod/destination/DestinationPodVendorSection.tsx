          ...
          {rows.length === 0 ? (
            ...
            <>
              ...
              {orderingStatus.tone === "limited" && (
                <div
                  className="mb-5 rounded-xl border border-oo-light-stone bg-oo-cream px-4 py-3 text-sm text-oo-charcoal"
                  role="status"
                >
                ...
                {rows.map(({ vendor, isFeatured, availability }) => {
                  ...
                  return (
                    <li
                      ...
                      className={
                        isHighlighted
                          ? "scroll-mt-36 rounded-2xl p-0.5 ring-2 ring-brand ring-offset-2 ring-offset-oo-cream"
