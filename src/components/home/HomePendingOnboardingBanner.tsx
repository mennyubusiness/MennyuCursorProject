      ...
      <PageShell className="flex flex-col gap-4 py-5 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-amber-900/80">
            {podInviteActive
              ? `Continue setup to join ${pendingInvite.podName}.`
              : isVendorSetup
