/**
 * Deliverect preparation time update webhook — acknowledged; kitchen prep time sync not implemented yet.
 */
...
export async function POST(request: NextRequest) {
  ...
  console.info("[DELIVERECT PREP TIME WEBHOOK] received; not_implemented_v1");
