/**
 * Deliverect courier status webhook — acknowledged; courier integration not implemented yet.
 */
...
export async function POST(request: NextRequest) {
  ...
  console.info("[DELIVERECT COURIER WEBHOOK] received; not_implemented_v1");
