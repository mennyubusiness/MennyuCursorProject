...
export const ADMIN_AUDIT_ACTION = {
  ...
  UNCLAIMED_VENDOR_CREATED: "UNCLAIMED_VENDOR_CREATED",
  VENDOR_CLAIM_INVITE_SENT: "VENDOR_CLAIM_INVITE_SENT",
  VENDOR_CLAIM_INVITE_RESENT: "VENDOR_CLAIM_INVITE_RESENT",
  VENDOR_CLAIM_INVITE_REVOKED: "VENDOR_CLAIM_INVITE_REVOKED",
  VENDOR_CLAIMED: "VENDOR_CLAIMED",
  UNCLAIMED_POD_CREATED: "UNCLAIMED_POD_CREATED",
  POD_CLAIM_INVITE_SENT: "POD_CLAIM_INVITE_SENT",
  POD_CLAIM_INVITE_RESENT: "POD_CLAIM_INVITE_RESENT",
  POD_CLAIM_INVITE_REVOKED: "POD_CLAIM_INVITE_REVOKED",
  POD_CLAIMED: "POD_CLAIMED",
  ...
  /** Durable menu-only product mode, distinct from the temporary pause actions above. */
  VENDOR_ORDERING_MODE_MENU_ONLY: "VENDOR_ORDERING_MODE_MENU_ONLY",
  VENDOR_ORDERING_MODE_ENABLED: "VENDOR_ORDERING_MODE_ENABLED",
  ...
  /** Durable pod-wide menu-only product mode, distinct from the temporary pause actions above. */
  POD_ORDERING_MODE_MENU_ONLY: "POD_ORDERING_MODE_MENU_ONLY",
  POD_ORDERING_MODE_ENABLED: "POD_ORDERING_MODE_ENABLED",
