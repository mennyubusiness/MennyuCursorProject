...
const AUDIT_LABELS: Record<string, string> = {
  ...
  [ADMIN_AUDIT_ACTION.UNCLAIMED_POD_CREATED]: "Unclaimed pod created",
  [ADMIN_AUDIT_ACTION.POD_CLAIM_INVITE_SENT]: "Pod claim invitation sent",
  [ADMIN_AUDIT_ACTION.POD_CLAIM_INVITE_RESENT]: "Pod claim invitation resent",
  [ADMIN_AUDIT_ACTION.POD_CLAIM_INVITE_REVOKED]: "Pod claim invitation revoked",
  [ADMIN_AUDIT_ACTION.POD_CLAIMED]: "Pod claimed",
