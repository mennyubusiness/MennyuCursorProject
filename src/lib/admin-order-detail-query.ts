...
export const adminOrderDetailSelect = Prisma.validator<Prisma.OrderSelect>()({
  ...
  issues: {
    ...
    select: {
      ...
      updatedAt: true,
      resolvedAt: true,
      linkedOrderRefund: { select: { id: true, status: true, amountCents: true } },
  ...
  orderRefunds: {
    orderBy: { createdAt: "desc" },
    select: { id: true, amountCents: true, status: true, refundScope: true, createdAt: true },
  },
  ...
  vendorOrders: {
    select: {
      ...
      deliverectPayloadValidation: true,
      vendor: { select: { id: true, name: true, deliverectChannelLinkId: true, orderRoutingMode: true } },
